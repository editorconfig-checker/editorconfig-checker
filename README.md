...
<!-- x-release-please-start-version -->
```shell
docker run --rm --volume=$PWD:/check ghcr.io/editorconfig-checker/editorconfig-checker:4.0.2
```

or

```shell
docker run --rm --volume=$PWD:/check mstruebing/editorconfig-checker:4.0.2
```
<!-- x-release-please-end -->
...
```json
{
  "$schema": "https://raw.githubusercontent.com/editorconfig-checker/editorconfig-checker/v4.0.2/.editorconfig-checker.schema.json",
  "Verbose": false,
  "Debug": false,
